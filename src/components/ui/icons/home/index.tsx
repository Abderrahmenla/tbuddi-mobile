const HomeIcon = ({ fill = "none" }: { fill: string }) => {
    return (
        <svg xmlns='http://www.w3.org/2000/svg' width='800' height='800' fill={fill} viewBox='0 0 1024 1024'>
